import numpy as np
import torch
from Contrastive_uncertainty.general.callbacks.gradcam.pytorch_grad_cam.base_cam import BaseCAM
from Contrastive_uncertainty.general.callbacks.gradcam.pytorch_grad_cam.utils.find_layers import find_layer_predicate_recursive
