...
repeat_callbacks=['NN Class Fraction']
...
runs = api.runs(path="nerdk312/evaluation", filters={"config.group":"OOD hierarchy baselines","config.epochs":300,"config.model_type": "CE","config.dataset": "Caltech256"})
