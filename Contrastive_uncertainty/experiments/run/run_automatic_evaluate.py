...
'''
runs1 = api.runs(path="nerdk312/evaluation", filters={"config.group":"Baselines Repeats","config.dataset": "CIFAR100","config.epochs":300,"$and": [{"config.seed":{"$eq": 26}},{"config.seed":{"$eq": 75}},{"config.seed":{"$eq": 100}},{"config.seed":{"$eq": 42}}],"$or": [{'state':'finished'}, {'state':'crashed'},{'state':'failed'}]})
runs2 = api.runs(path="nerdk312/evaluation", filters={"config.group":"Baselines Repeats","config.dataset": "CIFAR10","config.epochs":300,"$and": [{"config.seed":{"$eq": 26}},{"config.seed":{"$eq": 42}}],"$or": [{'state':'finished'}, {'state':'crashed'},{'state':'failed'}]})
runs3 = api.runs(path="nerdk312/evaluation", filters={"config.group":"Baselines Repeats","config.dataset": "Caltech256","config.epochs":300,"$and": [{"config.seed":{"$eq": 26}},{"config.seed":{"$eq": 42}}],"$or": [{'state':'finished'}, {'state':'crashed'},{'state':'failed'}]})
runs4 = api.runs(path="nerdk312/evaluation", filters={"config.group":"Baselines Repeats","config.dataset": "TinyImageNet","config.epochs":300,"$and": [{"config.seed":{"$ne": 26}},{"config.seed":{"$eq": 42}}],"$or": [{'state':'finished'}, {'state':'crashed'},{'state':'failed'}]})
runs5 = api.runs(path="nerdk312/evaluation", filters={"config.group":"Baselines Repeats","config.dataset": "MNIST","config.epochs":300,"$and": [{"config.seed":{"$eq": 26}},{"config.seed":{"eq": 42}}],"$or": [{'state':'finished'}, {'state':'crashed'},{'state':'failed'}]})
runs6 = api.runs(path="nerdk312/evaluation", filters={"config.group":"Baselines Repeats","config.dataset": "FashionMNIST","config.epochs":300,"$and": [{"config.seed":{"$eq": 26}},{"config.seed":{"$eq": 42}}],"$or": [{'state':'finished'}, {'state':'crashed'},{'state':'failed'}]})
runs7 = api.runs(path="nerdk312/evaluation", filters={"config.group":"Baselines Repeats","config.dataset": "KMNIST","config.epochs":300,"$and": [{"config.seed":{"$eq": 26}},{"config.seed":{"$eq": 42}}],"$or": [{'state':'finished'}, {'state':'crashed'},{'state':'failed'}]})
'''

#runs1 = api.runs(path="nerdk312/evaluation", filters={"config.group":"Baselines Repeats","config.model_type": "SupCon","config.dataset": "CIFAR100","config.epochs":300,"$and": [{"config.seed":{"$ne": 25}},{"config.seed":{"$ne": 125}},{"config.seed":{"$ne": 175}},{"config.seed":{"$ne": 150}}],"$or": [{'state':'finished'}, {'state':'crashed'},{'state':'failed'}]})
#runs1 = api.runs(path="nerdk312/evaluation", filters={"config.group":"Baselines Repeats","config.model_type": "SupCon","config.dataset": "CIFAR100","config.epochs":300,"$and": [{"config.seed":{"$ne": 25}},{"config.seed":{"$ne": 125}},{"config.seed":{"$ne": 175}},{"config.seed":{"$ne": 150}}]})
...
#runs1 = api.runs(path="nerdk312/evaluation", filters={"config.group":"OOD hierarchy baselines","config.epochs":300,"config.model_type": "CE","config.dataset": "CIFAR10","$or": [{'state':'finished'}, {'state':'crashed'},{'state':'failed'}]})
'''
runs2 = api.runs(path="nerdk312/evaluation", filters={"config.group":"OOD hierarchy baselines","config.epochs":300,"config.model_type": "CE","config.dataset": "CIFAR100","$or": [{'state':'finished'}, {'state':'crashed'},{'state':'failed'}]})
'''
...
'''
runs1 = api.runs(path="nerdk312/evaluation", filters={"config.group":"Baselines Repeats","config.epochs":300,"config.model_type": "SupCon","config.dataset": "CIFAR10","$or": [{'state':'finished'}, {'state':'crashed'},{'state':'failed'}]})
runs2 = api.runs(path="nerdk312/evaluation", filters={"config.group":"Baselines Repeats","config.epochs":300,"config.model_type": "SupCon","config.dataset": "CIFAR100","$or": [{'state':'finished'}, {'state':'crashed'},{'state':'failed'}]})
runs3 = api.runs(path="nerdk312/evaluation", filters={"config.group":"Baselines Repeats","config.epochs":300,"config.model_type": "SupCon","config.dataset": "TinyImageNet","$or": [{'state':'finished'}, {'state':'crashed'},{'state':'failed'}]})
runs4 = api.runs(path="nerdk312/evaluation", filters={"config.group":"Baselines Repeats","config.epochs":300,"config.model_type": "SupCon","config.dataset": "Caltech256","$or": [{'state':'finished'}, {'state':'crashed'},{'state':'failed'}]})
'''
#runs1 = api.runs(path="nerdk312/evaluation", filters={"config.group":"OOD hierarchy baselines","config.epochs":300,"config.model_type": "CE","config.dataset": "TinyImageNet"})
runs2 = api.runs(path="nerdk312/evaluation", filters={"config.group":"OOD hierarchy baselines","config.epochs":300,"config.model_type": "CE","config.dataset": "Caltech256"})
runs3 = api.runs(path="nerdk312/evaluation", filters={"config.group":"OOD hierarchy baselines","config.epochs":300,"config.model_type": "SupCon","config.dataset": "TinyImageNet"})
runs4 = api.runs(path="nerdk312/evaluation", filters={"config.group":"OOD hierarchy baselines","config.epochs":300,"config.model_type": "SupCon","config.dataset": "Caltech256"})


collated_runs = [runs2, runs3, runs4]
...
runs3 = api.runs(path="nerdk312/evaluation", filters={"config.group":"Baselines Repeats","config.model_type": "CE","config.dataset": "CIFAR10","config.epochs":300,"$or": [{'state':'finished'}, {'state':'crashed'},{'state':'failed'}]})
runs4 = api.runs(path="nerdk312/evaluation", filters={"config.group":"Baselines Repeats","config.model_type": "CE","config.dataset": "Caltech256","config.epochs":300,"$or": [{'state':'finished'}, {'state':'crashed'},{'state':'failed'}]})
#runs = api.runs(path="nerdk312/evaluation", filters={"config.group":"Baselines Repeats","config.model_type": "SupCon","config.seed":125,"config.epochs":300,"$or": [{'state':'finished'}, {'state':'crashed'},{'state':'failed'}]})
collated_runs = [runs2,runs3, runs4]
'''
